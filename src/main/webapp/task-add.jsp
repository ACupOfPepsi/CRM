        ...
        function addayalisys(obj) {
            $.ajax({
                ...
                success:function (rs) {
                    ...
                    var option2 = "<option class='opt'>"+rs.title+"</option>";
                    $("#anid").append(option2);
                    // $("#anid").val(rs.title);


                    $(rs.modules).each(function (index,item) {
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<select id="anid"><option>请选择需求</option></select>
		<%--<input type="text" id="anid">--%>

		-<select id="mod" onchange="addfunc(this.value)"><option>请选择模块</option></select>-
		<select id="fun" name="funFk"><option>请选择功能</option></select>
	</td>
</tr>
<tr >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="starttime" type="date"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">结束时间：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="endtime" type="date"/></td>
</tr>
<tr >
