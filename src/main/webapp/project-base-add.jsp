	...
	<script type="text/javascript">
           $(function(){
                // 获取客户方信息
                 $.ajax({
					 type:'GET',
					 url:'${pageContext.request.contextPath}/cus/showAllInfo',
					 dataType:'json',
					 success:function(rs){
               ...
               $.ajax({
                   type:'GET',
                   url:'${pageContext.request.contextPath}/emp/showManagerInfo',
				   data:{"pFk":4},
                   dataType:'json',
                   success:function(rs){
                       $(rs).each(function(index,item){
...
<form name="form4" id="form4" action="${pageContext.request.contextPath}/pro/savePro" method="POST">
