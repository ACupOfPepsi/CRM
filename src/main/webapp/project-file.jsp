...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/attachment/showAllInfo',
                dataType:'json',
                success:function (resultData) {
                    $(resultData).each(function (index,item) {
                        var tr = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                            ...
                            "\t<td>2020-7-7</td>\n" +
                            "\t<td>2020-7-7</td>\n" +
                            "\t<td><a href=\"${pageContext.request.contextPath}/attachment/download?id="+item.id+"\">下载</a> |<a href=\"#\">删除</a> |<a href=\"project-file-edit.jsp\">编辑</a> | <a href=\"project-file-look.jsp\">查看详情</a></td>\n" +
                            "</tr>";
                        $("#trr").after(tr);
                    });
                }
...
<tr align="center" bgcolor="#FAFAF1" height="22" id="trr">
	<td width="4%">选择</td>
	<td width="6%">序号</td>
	<td width="15%">附件名称</td>
	<td width="15%">所属项目</td>
