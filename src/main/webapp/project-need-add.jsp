...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/pro/showNoAnalysisInfo',
                dataType:'json',
...
<form name="form2" action="${pageContext.request.contextPath}/analysis/saveInfo" id="form3" method="post" enctype="multipart/form-data">
...
<tr >
    ...
    <tr >
		<td align="right" bgcolor="#FAFAF1" height="22">项目需求文档：</td>
