              ...
              $.ajax({
                  ...
                  success:function(rs){
                      $(rs).each(function(index,item){
                          //2020-07-06 格式化日期
                          var dataInfo1 = new Date(item.starttime);
                          var starttime = dataInfo1.getFullYear()+"-"+(dataInfo1.getMonth()+1)+"-"+dataInfo1.getDate();
                          var dataInfo2 = new Date(item.buildtime);
                          var buildtime = dataInfo2.getFullYear()+"-"+(dataInfo2.getMonth()+1)+"-"+dataInfo2.getDate();
                          var dataInfo3 = new Date(item.endtime);
                          var endtime = dataInfo3.getFullYear()+"-"+(dataInfo3.getMonth()+1)+"-"+dataInfo3.getDate();
