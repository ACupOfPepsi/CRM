...
public class EmailController {
    ...
    @RequestMapping("sendMail")
        public String sendMail(Email email, String reemp, MultipartFile file) throws MessagingException, UnsupportedEncodingException {

        // 发件人的邮箱和密码
        String myEmailAccount = "ACupOfPepsi@163.com";
        String myEmailPassword = "quest007";// 邮箱密码
        ...
        Authenticator auth = new Authenticator() {
            public PasswordAuthentication getPasswordAuthentication() {
                // 授权码验证
                return new PasswordAuthentication("ACupOfPepsi", "SPKRTDXDUUZXPXNF");// 邮箱的授权码
            }
        };
